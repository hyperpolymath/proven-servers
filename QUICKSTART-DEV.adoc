...
* *Bindings*: 20 languages in `bindings/` — Ada, C++, C#, Dart, Elixir, Gleam,
  Go, Haskell, Java, JavaScript, Julia, Kotlin, Lua, OCaml, PHP, Python, ReScript,
  Ruby, Rust, Swift — thin wrappers over the same C ABI (Elixir/Gleam/ReScript are
  constants-only scaffolds pending FFI; see ADR 0003).
