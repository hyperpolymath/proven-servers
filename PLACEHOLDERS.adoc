...
|===
|Placeholder |Description |Example |Files
|`+Proven Servers+` |Human-readable project name |`+My Project+`
|SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile,
GOVERNANCE.md, MAINTAINERS.md, flake.nix, devcontainer.json
...
|`+proven-servers+` |Repository name (slug) |`+my-project+`
