...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/proven-servers/security/advisories/new)
...
- This repository (`hyperpolymath/proven-servers`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/proven-servers/security/advisories)
...
When using proven-servers, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/proven-servers/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/proven-servers/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/proven-servers/discussions) |
...
*Thank you for helping keep proven-servers and its users safe.* 🛡️
