...
=== Claim 3: "ABI-FFI Standard: 20 Language Bindings"
...
| `bindings/` | 20 language-specific thin wrappers over the C ABI (ada/, cpp/, csharp/, dart/, elixir/, gleam/, go/, haskell/, java/, javascript/, julia/, kotlin/, lua/, ocaml/, php/, python/, rescript/, ruby/, rust/, swift/). No safety logic in bindings — see ADR 0003 + `.machine_readable/BINDINGS.a2ml`
