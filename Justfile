...
doctor:
    @echo "Running diagnostics for proven-servers..."
...
heal:
    @echo "Attempting auto-repair for proven-servers..."
...
help-me:
    @echo "=== proven-servers Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/proven-servers/issues/new"
    @echo ""
