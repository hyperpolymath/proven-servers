...
;;
;; Guix package definition for proven-servers
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace proven-servers and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/proven-servers")
  (synopsis "Formally verified server components with dependent-type proofs")
