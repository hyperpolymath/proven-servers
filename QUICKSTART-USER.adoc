...
// Replace proven-servers, Proven Servers — See README.adoc for details., just run, Proven Servers started successfully. with actuals
= proven-servers — Quick Start for Users
:toc:
:toclevels: 2

== What is proven-servers?

Proven Servers — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./proven-servers-portable
----
...
[source]
----
Proven Servers started successfully.
----
