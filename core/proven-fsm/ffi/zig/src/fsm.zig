...
comptime {
    if (@sizeOf(@TypeOf(machines)) > 16 * 1024 * 1024)
        @compileError("pool 'machines' exceeds the 16 MiB budget; heap-allocate or shrink (see audits/proof-panic-attack-2026-06-23.md)");
}
