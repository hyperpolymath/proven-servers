...
#
# TODO: Replace proven-servers and Formally verified server components in Idris 2 with Zig FFI with actual values.

{
  description = "proven-servers — RSR-compliant project";
    ...
    flake-utils.lib.eachSystem [ "x86_64-linux" "aarch64-linux" ] (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            if [ -z "''${DIRENV_IN_ENVRC:-}" ] && [ -f .envrc ]; then
              ...
              export PROJECT_NAME="proven-servers"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            echo "TODO: Add build commands for proven-servers"
          '';
          ...
          meta = with pkgs.lib; {
            description = "Formally verified server components in Idris 2 with Zig FFI";
