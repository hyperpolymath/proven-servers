...
export const PtpMessageType = Object.freeze({
  SYNC: 0,
  DELAY_REQ: 1,
  PDELAY_REQ: 2,
  PDELAY_RESP: 3,
...
export const ClockClass = Object.freeze({
  PRIMARY_CLOCK: 0,
...
export const PtpPortState = Object.freeze({
  INITIALIZING: 0,
  FAULTY: 1,
  DISABLED: 2,
  LISTENING: 3,
...
export const DelayMechanism = Object.freeze({
  E2_E: 0,
  P2_P: 1,
  DM_DISABLED: 2,
});
