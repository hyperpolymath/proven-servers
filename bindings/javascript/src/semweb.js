...
export const RdfFormat = Object.freeze({
  RDF_XML: 0,
  TURTLE: 1,
  N_TRIPLES: 2,
  N_QUADS: 3,
...
export const SemwebResourceType = Object.freeze({
  CLASS: 0,
  PROPERTY: 1,
  INDIVIDUAL: 2,
  ONTOLOGY: 3,
...
export const ContentNegotiation = Object.freeze({
  NEG_RDF_XML: 0,
  NEG_TURTLE: 1,
  NEG_JSON_LD: 2,
  NEG_HTML: 3,
...
export const SemwebErrorCode = Object.freeze({
  NOT_FOUND: 0,
  INVALID_URI: 1,
  MALFORMED_RDF: 2,
