...
# proven-servers container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping proven-servers..."
...
# Examples:
#   exec /app/proven-servers
#   exec /app/release/bin/proven-servers start
#   exec /app/proven-servers serve --host "${APP_HOST}" --port "${APP_PORT}"
