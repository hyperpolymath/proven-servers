...
//
// Build configuration for proven-config FFI.
...
pub fn build(b: *std.Build) void {
    ...
    const shared_lib = b.addLibrary(.{
        .name = "proven_config", .root_module = lib_module, .linkage = .dynamic,
    });
    ...
    const static_lib = b.addLibrary(.{
        .name = "proven_config", .root_module = static_mod, .linkage = .static,
    });
