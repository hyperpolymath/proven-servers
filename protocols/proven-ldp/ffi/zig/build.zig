...
//
// Build configuration for proven-ldp FFI.
//
...
pub fn build(b: *std.Build) void {
    ...
    const lib_module = b.createModule(.{
        .root_source_file = b.path("src/ldp.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const ldp_module = b.createModule(.{
        .root_source_file = b.path("src/ldp.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const test_module = b.createModule(.{
        .root_source_file = b.path("test/ldp_test.zig"),
        .target = target,
        .optimize = optimize,
        .imports = &.{
            .{ .name = "ldp", .module = ldp_module },
        },
    });
