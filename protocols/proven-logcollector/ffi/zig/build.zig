...
//
// Build configuration for proven-logcollector FFI.
//
...
pub fn build(b: *std.Build) void {
    ...
    const lib_module = b.createModule(.{
        .root_source_file = b.path("src/logcollector.zig"),
        .target = target,
        .optimize = optimize,
    });

    const shared_lib = b.addLibrary(.{
        .name = "proven_logcollector",
    ...
    const lc_module = b.createModule(.{
        .root_source_file = b.path("src/logcollector.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    const test_module = b.createModule(.{
        .root_source_file = b.path("test/logcollector_test.zig"),
        .target = target,
        .optimize = optimize,
        .imports = &.{
            .{ .name = "lc", .module = lc_module },
        },
    });
